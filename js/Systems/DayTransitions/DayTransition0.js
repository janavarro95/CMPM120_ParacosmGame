...
//Check to see how many seconds have passed to either draw text to the screen or progress to the next day.
DayTransition0.prototype.update=function(){

if(this.counter==1){
	console.log("SHOW THE DATE TEXT!!!");
    var text1 = game.add.text(game.world.centerX, (game.world.centerY/2)+100, "Day 0", this.style1);
    text1.anchor.setTo(.5,.5);
}

if(this.counter==2){
	var text2 = game.add.text((game.world.centerX),(game.world.centerY), "October 21, 1995", this.style2);
