/*
A special NPC that is the "gatekeeper" between days that ensures that the playr has finished their task of delivering mail for the day. Also this "NPC" can't talk as that would be weird.
*/
var EXMarkSprite;

var MailBox= function(xPos,yPos,npcString){
Phaser.Sprite.call(this,game,xPos,yPos,npcString,null);
console.log("Make my mailbox");
}
